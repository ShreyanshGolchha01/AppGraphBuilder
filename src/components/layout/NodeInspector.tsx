...
export const NodeInspector = () => {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      >
        <TabsList className="w-full justify-start rounded-none bg-black border-b border-gray-800 h-auto p-0">
          <TabsTrigger
            value="config"
        ...
        <TabsContent value="config" className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            <div className="bg-gray-900 rounded-lg p-3 border border-gray-800">
              ...
              <p className="text-white font-medium">{selectedNode.data.cpuUsage.toFixed(2)}</p>
            </div>
            <div className="bg-gray-900 rounded-lg p-3 border border-gray-800">
              <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-white font-medium">{selectedNode.data.memoryUsage}</p>
            </div>
            <div className="bg-gray-900 rounded-lg p-3 border border-gray-800">
              <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-white font-medium">{selectedNode.data.diskUsage}</p>
            </div>
            <div className="bg-gray-900 rounded-lg p-3 border border-gray-800">
              <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-white font-medium">{selectedNode.data.regionCount}</p>
            </div>
          </div>
        </TabsContent>

        <TabsContent value="runtime" className="flex-1 overflow-y-auto p-4 space-y-4">
